...
<body>
	...
	<form class="form-horizontal" action="DeviceServlet?action=add"
		method="post" role="form" enctype="multipart/form-data">
		<div class="form-group">
			<label class="col-md-4 control-label">设备型号id：</label>
			<div class="col-md-4">
				<input class="form-control" name="dtid" id="dtid"
					placeholder="请输入设备型号id" type="text" required>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-4">
				<input class="form-control" name="devicename" id="devicename"
					placeholder="请输入设备型号名称" type="text" required>
			</div>
		</div>
		<div class="form-group">
